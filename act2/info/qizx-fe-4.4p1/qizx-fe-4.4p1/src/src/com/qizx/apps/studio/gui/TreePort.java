...
public class TreePort extends ToolView
{
        ...
        tree.addMouseListener(new MouseAdapter() {
                ...
                public void mouseReleased(MouseEvent e)
                {
                    ...
                    if (path != null) {
                        TNode node = (TNode) path.getLastPathComponent();
                        if (node != null)
                            node.buttonReleased(e, TreePort.this);
                    }
                }
    ...
    public void refreshNodeContent(TNode node)
    {
        ...
        implements ActionListener
    {
        ...
        protected void buttonReleased(MouseEvent e, TreePort tree)
        {
        }
    ...
    {
        // If ! null, defines sections of text with color pairs (style, length)
        protected StringBuilder sections;
        ...
        protected void endSection(StringBuilder buf, int style)
        {
            ...
            sections.append(buf == null? 0 : (char) buf.length());
        }
    ...
    public static class NavigationNode extends ColoredNode
    {
        Action action;
        String label;
        
        public NavigationNode(String label, Action action)
        {
            this.label = label;
            this.action = action;
        }
...
//        }
    ...
    public static class Renderer extends DefaultTreeCellRenderer
    {
            ...
            boolean hasFocus)
        {
            ...
            Component c = currentNode.getRenderer();
            if (c != null)
                return c;
        ...
        public void paintSections(String text, StringBuilder sections, Graphics g)
        {
            int start = 0;
            int x = 0;
