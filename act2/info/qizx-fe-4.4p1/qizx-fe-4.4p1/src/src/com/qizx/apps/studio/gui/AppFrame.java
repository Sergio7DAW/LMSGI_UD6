...
{   
    ...
    public void centerInScreen(int xpadding, int ypadding)
        throws HeadlessException
    {
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        setBounds(xpadding, ypadding, screenSize.width - 2 * xpadding,
                  screenSize.height - 2 * ypadding); //
        setVisible(true);
    }
    ...
    public JMenu newMenu(String header)
    {
