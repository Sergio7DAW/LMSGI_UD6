...
public class Util
{
    ...
    /**
     * Compares 2 char arrays in codepoint order
     */
    ...
    /**
     * Convert and round nano-time to milliseconds.
     * @param nanos time in nanoseconds
     */
    public static long nanoToMillis(long nanos)
    {
        return (nanos + 500000) / 1000000;
    }
    ...
    static final ArrayIntSet URI_SET = new ArrayIntSet();
    static ArrayIntSet URI2_SET; // to escape illegal characters in URI
    static ArrayIntSet IRI_SET;
    static final ArrayIntSet HTML_SET = new ArrayIntSet();
    ...
    static {
        ...
        URI2_SET = (ArrayIntSet) URI_SET.copy();
        URI2_SET.add('/');

        IRI_SET = (ArrayIntSet) URI_SET.copy();
...
// return ((int) (bits >>> 32)) ^ ((int) bits);
    ...
    {
        try {
            return java.beans.Beans.instantiate(Util.class.getClassLoader(), className);
        }
        catch (IOException e) {
    ...
    {
        Logger logger = (name == null)? Logger.getAnonymousLogger()
    ...
    // Also used in server
    public static void crcUpdate(CRC32 crc, long l)
    {
        crc.update((int) l);
        crc.update((int) (l >>> 32));
    }
